output "data_factory_linked_custom_services_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.id if v.id != null && length(v.id) > 0 }
}
output "data_factory_linked_custom_services_additional_properties" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.additional_properties if v.additional_properties != null && length(v.additional_properties) > 0 }
}
output "data_factory_linked_custom_services_annotations" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.annotations if v.annotations != null && length(v.annotations) > 0 }
}
output "data_factory_linked_custom_services_data_factory_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.data_factory_id if v.data_factory_id != null && length(v.data_factory_id) > 0 }
}
output "data_factory_linked_custom_services_description" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.description if v.description != null && length(v.description) > 0 }
}
...
output "data_factory_linked_custom_services_name" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.name if v.name != null && length(v.name) > 0 }
}
output "data_factory_linked_custom_services_parameters" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.parameters if v.parameters != null && length(v.parameters) > 0 }
}
output "data_factory_linked_custom_services_type" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.type if v.type != null && length(v.type) > 0 }
}
output "data_factory_linked_custom_services_type_properties_json" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_custom_service.data_factory_linked_custom_services : k => v.type_properties_json if v.type_properties_json != null && length(v.type_properties_json) > 0 }
}
